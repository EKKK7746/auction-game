...
const CARD_LORE = {
  ssdc: '素纱襌衣，西汉长沙国利苍妻辛追墓出土。衣长128cm，袖长190cm，重仅49克，折叠可塞入火柴盒。是世界上最轻的古代丝织品，展现了西汉缫丝技术的巅峰。',
  mfl: '皿方罍，商代晚期青铜盛酒器。1919年出土于湖南桃源，器身与盖分离近百年。器身饰兽面纹，铸造工艺登峰造极。',
  slj: '双鸾双兽镜，西汉铜镜精品。镜背铸有双鸾双兽纹饰，造型灵动。镜中世界暗藏玄机——持有此镜者，终局时可发起"镜中决斗"，与对手各押一宝，出价高者夺得对方珍品。',
  ssyz: '神兽玉樽，西汉贵族酒器。以和田白玉雕琢，器身浮雕青龙白虎朱雀玄武四神兽。是西汉"事死如生"丧葬观念的物证。',
  lfh: '龙凤帛画，战国楚墓出土。画中龙凤飞舞，引导墓主人灵魂升天。是中国现存最早的绢帛绘画之一。',
  yulb: '御龙帛画，战国楚墓出土。男子御龙驰骋天际，龙、鹭、鱼相伴。与龙凤帛画并称"楚帛双璧"。',
...
function _renderPlayerList(view) {
  ...
  list.innerHTML = allPlayers.map(p => {
    ...
    else if (p.cards && p.cards.some(c => c.id === 'dsy' && c.used)) skillDetail.push('⬆️ 骰子升级（已使用）');
